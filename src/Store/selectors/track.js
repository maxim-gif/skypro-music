...
export const classicMusicTrackSelector = (store) =>
    store.playerControl.classicMusicTrack

export const rockMusicTrackSelector = (store) =>
    store.playerControl.rockMusicTrack

export const electroMusicTrackSelector = (store) =>
    store.playerControl.electroMusicTrack
